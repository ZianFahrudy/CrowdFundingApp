...
import '../component/blocs/campaign/campaign_detail_bloc.dart' as _i13;
import '../component/blocs/campaign/campaign_list_bloc.dart' as _i14;
import '../component/blocs/login/login_bloc.dart' as _i11;
import '../component/blocs/transaction/checkout_bloc.dart' as _i10;
import '../component/blocs/transaction/transaction_list_bloc.dart' as _i12;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i12.TransactionListBloc>(
      () => _i12.TransactionListBloc(get<_i4.TransactionRepository>()));
  gh.factory<_i13.CampaignDetailBloc>(
      () => _i13.CampaignDetailBloc(get<_i8.CampaignRepository>()));
  gh.factory<_i14.CampaignListBloc>(
      () => _i14.CampaignListBloc(get<_i8.CampaignRepository>()));
  gh.factory<_i14.CampaignListByIdBloc>(
      () => _i14.CampaignListByIdBloc(get<_i8.CampaignRepository>()));
  return get;
}

class _$DioModuleInjectable extends _i15.DioModuleInjectable {}
